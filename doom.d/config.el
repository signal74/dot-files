...
(setq user-full-name "Agent-727"
      user-mail-address "noreply@fbi.gov")
;;
...
(setq doom-font (font-spec :family "Hack Nerd Font" :size 13 :weight 'light)
...
;; hide the tags for code in org-mode
(setq org-hide-emphasis-markers t)

;; enable word-wrap (almost) everywhere
(+global-word-wrap-mode +1)

;; Remove the title bar and set the background opacity to 95
...
;; Ignore the 'rulesRefreshed warning popup
(after! lsp-mode
